...
public class resumenCWindow extends javax.swing.JDialog {

    Counter theSystem;
    
    public resumenCWindow(java.awt.Frame parent, boolean modal, Counter info) {
        super(parent, modal);
        initComponents();
        theSystem = info;
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(!InfoReview.fieldIsEmpty(anno)&&(InfoReview.isNumber(mes))){
            ...
            String datos = theSystem.getResumen(laFecha);

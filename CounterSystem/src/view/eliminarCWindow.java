...
public class eliminarCWindow extends javax.swing.JDialog {

    Counter theSystem;
    
    public eliminarCWindow(java.awt.Frame parent, boolean modal, Counter info) {
        super(parent, modal);
        initComponents();
        theSystem = info;
    }
